...
const LAYER_PATTERNS = {
    // Walls / Envelope
    envelope: [/wall/i, /mur/i, /cloison/i, /envelope/i, /facade/i, /boundary/i, /perimetre/i, /contour/i],

    // Obstacles (permanent structures) - expanded for French/English CAD standards
    obstacles: [
        /column/i, /poteau/i, /pillar/i, /pilier/i,      // Columns/pillars
        /shaft/i, /gaine/i, /duct/i, /conduit/i,          // Shafts/ducts
        /stair/i, /escalier/i, /marche/i, /palier/i,      // Stairs
        /elevator/i, /ascenseur/i, /lift/i, /monte/i,     // Elevators
        /void/i, /tremie/i, /opening/i, /ouverture/i,     // Voids/openings
        /beam/i, /poutre/i, /structure/i,                  // Structural beams
        /radiateur/i, /radiator/i, /chauffage/i, /heating/i, // Heating/radiators
        /ventil/i, /hvac/i, /cvc/i, /clima/i               // HVAC/ventilation
    ],

    // Forbidden zones (areas that cannot be used for placement)
    forbidden: [
        /forbidden/i, /interdit/i, /exclusion/i, /zone_exclu/i,
        /service/i, /technique/i, /technical/i, /local_tech/i,
        /wc/i, /toilet/i, /sanitary/i, /sanitaire/i, /douche/i, /shower/i,
        /reserve/i, /storage/i, /rangement/i, /stockage/i,
        /kitchen/i, /cuisine/i, /kitchenette/i
    ],

    // Exits and doors
    exits: [
        /exit/i, /sortie/i, /door/i, /porte/i,
        /entrance/i, /entree/i, /acces/i, /access/i,
        /emergency/i, /urgence/i, /secours/i, /evacuation/i,
        /issue/i, /degagement/i
    ],

    // Circulation / Corridor areas
    circulation: [/corridor/i, /couloir/i, /circulation/i, /passage/i, /hall/i, /lobby/i, /palier/i, /landing/i],

    // Gray/Tole Grise zones (reference image terminology)
    grayZones: [/tole/i, /gris/i, /gray/i, /grey/i, /metal/i, /acier/i, /steel/i]
};
