...
class WallGapCompleter {
    ...
    completeWalls(walls, zones) {
        ...
        for (let iteration = 0; iteration < MAX_ITERATIONS; iteration++) {
            ...
            const iterationSegments = syntheticSegments.map((seg) => ({
                ...seg,
                id: `synthetic_wall_${++syntheticIdCounter}`
            }));
