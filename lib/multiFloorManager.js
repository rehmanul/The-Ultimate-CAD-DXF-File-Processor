    ...
    _normalizeFloors(floors) {
        return floors
            .map((input, index) => {
                ...
                // Support both width/height and minX/maxX formats
                const hasWidthHeight = typeof bounds.width === 'number' && typeof bounds.height === 'number';
                const hasMinMax = typeof bounds.minX === 'number' && typeof bounds.maxX === 'number' 
                    && typeof bounds.minY === 'number' && typeof bounds.maxY === 'number';
                
                if (!hasWidthHeight && !hasMinMax) {
