...
function loadTensorflow() {
    ...
    try {
        ...
        const err = new Error('TensorFlow native bindings required. Install @tensorflow/tfjs-node before running ML workflows. Details: ' + details);
        err.cause = error;
        tfLoadError = err;
        throw err;
    }
