        ...
        try {
            ...
            if (error.code === 'EACCES' || error.code === 'EPERM') {
                ...
                try {
                    ...
                    console.error('[CostoProjectManager] Cannot create projects directory:', fallbackError);
                    // Continue anyway - project operations will fail gracefully
                }
            } else {
                throw error;
            }
...
module.exports = new CostoProjectManager();
