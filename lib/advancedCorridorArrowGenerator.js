...
class AdvancedCorridorArrowGenerator {
    ...
    _classifyCorridors(corridors, entrances, ilots) {
        ...
        corridors.forEach(corridor => {
            ...
            // Accept main/spine/vertical/horizontal and between_facing_rows as main corridors
            if (type.includes('main') || type.includes('spine') || type.includes('vertical') || type.includes('horizontal') || type.includes('between_facing_rows')) {
