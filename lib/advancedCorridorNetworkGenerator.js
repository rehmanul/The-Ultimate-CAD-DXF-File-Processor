    ...
    generateVerticalCorridors() {
        ...
        rows.forEach((row, rowIndex) => {
            ...
            for (let i = 0; i < sorted.length - 1; i++) {
                ...
                // Fix 1: Center vertical corridor alignment horizontally in the gap
    ...
    generateHorizontalCorridors() {
        ...
        columns.forEach((column, colIndex) => {
            ...
            for (let i = 0; i < sorted.length - 1; i++) {
                ...
                // Fix 1: Center horizontal corridor alignment vertically in the gap
        ...
        if (this.bounds && this.bounds.minX !== undefined && this.bounds.maxX !== undefined) {
            corridors.push({
                id: 'service_band_15m',
                type: 'horizontal',
                x: this.bounds.minX,
                ...
                corners: [
                    [this.bounds.minX, 15],
                    [this.bounds.maxX, 15],
                    [this.bounds.maxX, 15 + this.corridorWidth],
                    [this.bounds.minX, 15 + this.corridorWidth]
                ]
            });
        }
