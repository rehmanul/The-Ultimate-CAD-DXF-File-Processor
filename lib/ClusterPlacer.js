...
class ClusterPlacer {
    ...
    _checkGridCollision(b) {
        ...
        const startX = Math.floor(expanded.minX / this.gridSize);
        const endX = Math.floor(expanded.maxX / this.gridSize);
        const startY = Math.floor(expanded.minY / this.gridSize);
        const endY = Math.floor(expanded.maxY / this.gridSize);
