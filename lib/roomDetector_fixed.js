class RoomDetector {
    ...
    buildWallGraph(walls) {
        ...
        walls.forEach((wall, index) => {
            ...
            if (!nodes.has(startKey)) nodes.set(startKey, { x: wall.start.x, y: wall.start.y, id: startKey });
            if (!nodes.has(endKey)) nodes.set(endKey, { x: wall.end.x, y: wall.end.y, id: endKey });
        ...
        return { nodes: Array.from(nodes.values()), edges, hull };
    }
