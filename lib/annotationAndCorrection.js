...
class AnnotationAndCorrection {
    ...
    generateSuggestion(issue) {
        if (issue.includes('area')) {
            return this.suggestRoomResize(issue);
        }
        if (issue.includes('dimension')) {
            return this.suggestRoomResize(issue);
        }
        if (issue.includes('width')) {
            return this.suggestWidthAdjustment(issue);
        }
        if (issue.includes('color')) {
            return this.suggestRecolor(issue);
        }
        if (issue.includes('layer')) {
            return this.suggestRelayer(issue);
        }
        return null;
    }
