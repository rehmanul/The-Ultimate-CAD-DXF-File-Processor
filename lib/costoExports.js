...
`;
    ...
    async drawFloorPlanToPDF(page, floorPlan, solution, scale, offsetX, offsetY, options = {}) {
        ...
        const circulationPaths = Array.isArray(solution.circulationPaths) ? solution.circulationPaths : [];
        const corridors = solution.corridors || [];
        const flowArrowColor = options.greenArrows ? rgb(0.35, 0.05, 0.08) : COLORS.circulation;  // dark maroon
...
`;
    ...
    async exportToReferencePDF(solution, floorPlan, metrics, options = {}) {
        ...
        if (canMultiFloor) {
            ...
            await this.drawLeftVerticalLabels(page, {
